...
## How to Use
The key functions and examples of how to use this package can be found in [this document](https://github.com/q1cui/discourseGT/tree/main/vignettes/discourseGT.pdf).
